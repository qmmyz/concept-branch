...
| Gitleaks 8.30.1 working-tree scan | 0 findings |
...
The acceptance workflow uses temporary SQLite and provider directories, a synthetic account, a synthetic API key, and a local mock provider. No external model service or real credential is required.
